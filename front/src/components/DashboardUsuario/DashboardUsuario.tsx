      ...
      <section className="flex-1 bg-white p-6 rounded-lg shadow-md overflow-auto">
        ...
        {vista === "logros" && (
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {loading && <p className="text-center text-gray-600 col-span-full">Cargando logros...</p>}
            ...
            {!loading && !status && !error && (
              <p className="text-center text-gray-600 col-span-full">No se encontraron logros.</p>
            )}
          </div>
        )}
        {vista === "certificados" && (
