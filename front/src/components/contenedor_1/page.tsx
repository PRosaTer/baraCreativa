     ...
     >
       {children ? (
         ...
         <div className="p-3 sm:p-6 w-full">
           ...
           {/* Modificamos la clase del grid para que sea de 1 columna por defecto y de 2 en md o superior */}
           <div className="grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-4">
             ...
             {/* Tarjeta 5 */}
             {/* Mantenemos sm:col-span-2 para que ocupe todo el ancho en pantallas medianas o superiores */}
