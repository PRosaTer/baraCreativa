      ...
      {children ? (
        ...
        <div className="p-3 sm:p-6 w-full">
          ...
          <div className="flex flex-col lg:grid lg:grid-cols-2 gap-4">
            ...
            <div className="bg-white rounded-lg shadow-md p-3 sm:p-4 flex items-start space-x-2 sm:space-x-3 hover:shadow-lg transition-shadow lg:col-span-2">
              <span className="text-lg sm:text-2xl">🌟</span>
              <div>
                <h3 className="font-semibold text-blue-600 text-xs sm:text-base">
                  Bienestar educativo
